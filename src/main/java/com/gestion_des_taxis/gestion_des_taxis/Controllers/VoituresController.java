...
public class VoituresController implements Initializable {
    ...
    @FXML
    private TableColumn<Voiture, String> consomation_moyenne_Col;

    @FXML
    private TableColumn<Voiture, String> puissance_fiscale_Col;

    @FXML
    private TableColumn<Voiture, String> date_1er_immatru_Col;

    @FXML
    private TableColumn<Voiture, String> killometrage_Col;

    @FXML
    private TableColumn<Voiture, String> date_dernier_controle_tech_Col;

    @FXML
    private TableColumn<Voiture, String> km_dernirer_vidange_Col;

    @FXML
    private TableColumn<Voiture, String> km_dernier_courroie_Col;
    ...
    void exporter(MouseEvent event) throws IOException{
        ...
        Tools.alert(stackPane, anchorPane, "Les voitures sont etes exporte avec succés!");
    ...
    void modifier(MouseEvent event) {
        ...
        if (voiture != null) {
            try {
                ...
                AddVoitureController acc = loader.getController();
                acc.fillFields(voiture.getId(), voiture.getImmatriculation(), voiture.getMarque(), voiture.getModel(),voiture.getCarburant(),voiture.getConsomation_moyenne(),
                         voiture.getPuissance_fiscale(),voiture.getDate_1er_immatru(),voiture.getEtat(),
                        voiture.getKillometrage(),voiture.getDate_dernier_controle_tech(),voiture.getKm_dernier_vidange(),voiture.getKm_dernier_courroie());
            ...
            Tools.alert(stackPane, anchorPane, "Aucune ligne selectionnee!");
        }
        refrechTable("NULL");
   ...
   public void poubelle(MouseEvent event) {
       ...
       /*consomation_moyenne_Col.setCellValueFactory(new PropertyValueFactory<>("consomation_moyenne"));
       puissance_fiscale_Col.setCellValueFactory(new PropertyValueFactory<>("puissance_fiscale"));
       date_1er_immatru_Col.setCellValueFactory(new PropertyValueFactory<>("date_1er_immatru"));
       killometrage_Col.setCellValueFactory(new PropertyValueFactory<>("killometrage"));
       date_dernier_controle_tech_Col.setCellValueFactory(new PropertyValueFactory<>("date_dernier_controle_tech"));
       km_dernirer_vidange_Col.setCellValueFactory(new PropertyValueFactory<>("km_dernirer_vidange"));
       km_dernier_courroie_Col.setCellValueFactory(new PropertyValueFactory<>("km_dernirer_vidange"));*/
                   ...
                   if (empty) {
                       ...
                       delete.setOnMouseClicked((MouseEvent event) -> {
                           ...
                           if (voiture != null) {
                               ...
                               dialogLabel.setText("Voulez-vous supprimer définitivement cette voiture?");
                               ...
                               yesButton.setOnAction((Event) -> {
                                   voiture.hardDeletionVoiture(voiture.getId());
                                   refrechTable("NOT NULL");
...
//
                       ...
                       restor.setOnMouseClicked((MouseEvent event) -> {
                           ...
                           if (voiture != null) {
                               ...
                               Tools.alert(stackPane, anchorPane, "La voiture a été restauré avec succès!");
                               refrechTable("NOT NULL");
                           }
    ...
    public void softDelete(int id)
    {
        ...
        noButton.setFont(new Font(17));
        noButton.setCursor(Cursor.HAND);
        dialogLabel.setText("Voulez-vous dÃ©placer cette voiture vers la corbeille?");
        dialogLabel.setStyle("-fx-font-weight: bold; -fx-alignment: center; -fx-font-size: 20px; -fx-text-fill : #52438F;");
        dialog.setTransitionType(JFXDialog.DialogTransition.TOP);
        dialog.setDialogContainer(stackPane);
        dialog.show();
